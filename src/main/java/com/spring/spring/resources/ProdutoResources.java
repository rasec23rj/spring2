...
import com.spring.spring.dto.ProdutoDTO;
import com.spring.spring.resources.utils.URL;
import com.spring.spring.service.ProdutoService;
...
public class ProdutoResources {
	...
	public ResponseEntity<?> index() {
		...
		List<Produto> obj = service.index();
